<template>
  <list-content-component :title="title" :service="service">
    ...
    <template slot="search" slot-scope="{searchParams}">
      ...
      <div class="form-group">
        <label>{{$t("asset.currentProbe.device.deviceModel")}}</label>
    ...
    <template slot="table" slot-scope="{isSelectable, pagingEvent}">
      ...
      <el-table-column min-width="105" prop="currentLevel" :label='$t("asset.currentProbe.device.currents")'></el-table-column>
      <el-table-column prop="compName" :label='$t("asset.currentProbe.device.compName")'></el-table-column>
      <el-table-column prop="asset" :label='$t("asset.currentProbe.device.assetName")'></el-table-column>
