  ...
  <list-content-component :title="title" :service="service">
    ...
    <template slot="search" slot-scope="{searchParams}">
      <div class="form-group">
        <label>{{$t("asset.flowProbe.device.compName")}}</label>
    ...
    <template slot="table" slot-scope="{isSelectable,pagingEvent,getSignalClass,getPowerClass}">
      ...
      <el-table-column prop="currentValue" :label='$t("asset.flowProbe.device.currentSpeed")'></el-table-column>
      <el-table-column prop="projectName" :label='$t("asset.flowProbe.device.compName")'></el-table-column>
      <el-table-column prop="assetManageName" :label='$t("asset.flowProbe.device.assetName")'></el-table-column>
