<template>
  <list-content-component :title="title" :service="service">
    ...
    <template slot="table" slot-scope="{isSelectable,pagingEvent,getSignalClass,getPowerClass}">
      ...
      <el-table-column prop="currentValue" :label='$t("asset.illuminanceProbe.device.illuminance")'></el-table-column>
      <el-table-column prop="projectName" :label='$t("asset.illuminanceProbe.device.compName")'></el-table-column>
      <el-table-column prop="assetManageName" :label='$t("asset.illuminanceProbe.device.assetName")'></el-table-column>
      ...
      <el-table-column :label='$t("asset.illuminanceProbe.device.alarmDuty")'>
