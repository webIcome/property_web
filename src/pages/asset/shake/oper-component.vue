  ...
  <div class="oper-component">
    ...
    <el-dialog :title="title" :visible.sync="visible" center :width="'500px'">
      <el-form label-width="120px" :model="data" :rules="Rules" :ref="ref" class="el-form-default" :validate-on-rule-change="false">
        <el-form-item :label='$t("asset.shake.device.sn")' prop="sn">
          <el-input v-model.trim="data.sn" :placeholder='$t("common.input")'></el-input>
        </el-form-item>
        <el-form-item :label='$t("asset.shake.device.deviceModel")' prop="deviceModel">
        ...
        <el-form-item :label='$t("asset.shake.device.alarmType")' prop="alarmType">
        ...
        <el-form-item :label='$t("asset.shake.device.compName")' prop="projectIds">
          <select-projects-component v-model="data.projectIds" style="width: 100%"></select-projects-component>
        </el-form-item>
        <el-form-item :label='$t("asset.shake.device.assetName")' prop="assetManageId">
        ...
        <el-form-item :label='$t("asset.shake.device.address")' prop="address">
    ...
    export default {
        ...
        data() {
            return {
                ...
                service: Service,
                deviceModel: CommonConstant.shake,
            }
        },
        methods: {
            resetData() {
