<template>
  <list-content-component :title="title" :service="service">
    ...
    <template slot="table" slot-scope="{isSelectable,pagingEvent,getSignalClass,getPowerClass}">
      ...
      <el-table-column prop="statusName" :label='$t("asset.temperatureHumidityProbe.device.statusName")'></el-table-column>
      <el-table-column prop="currentValue" :label='$t("asset.temperatureHumidityProbe.device.currentTemperatureHumidity")'></el-table-column>
      <el-table-column prop="projectName" :label='$t("asset.temperatureHumidityProbe.device.compName")'></el-table-column>
