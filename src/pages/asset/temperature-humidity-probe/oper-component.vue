  ...
  <div class="oper-component">
    ...
    <el-dialog :title="title" :visible.sync="visible" center :width="'500px'">
      <el-form label-width="170px" :model="data" :rules="Rules" :ref="ref" class="el-form-default" :validate-on-rule-change="false">
        <el-form-item :label='$t("asset.temperatureHumidityProbe.device.sn")' prop="deviceName">
        ...
        <el-form-item :label='$t("asset.temperatureHumidityProbe.device.compName")' prop="deviceName">
          <el-input v-model.trim="data.deviceName" :placeholder='$t("common.input")'></el-input>
        </el-form-item>
        <el-form-item :label='$t("asset.temperatureHumidityProbe.device.assetName")' prop="deviceName">
          <el-input v-model.trim="data.deviceName" :placeholder='$t("common.input")'></el-input>
        </el-form-item>
        <el-form-item :label='$t("asset.temperatureHumidityProbe.device.address")' prop="deviceName">
          <el-input v-model.trim="data.deviceName" :placeholder='$t("common.input")'></el-input>
        </el-form-item>
      </el-form>
