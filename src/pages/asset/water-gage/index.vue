<template>
  <list-content-component :title="title" :service="service">
    ...
    <template slot="search" slot-scope="{searchParams}">
      ...
      <div class="form-group">
        <label>{{$t("asset.waterGage.device.deviceModel")}}</label>
    ...
    <template slot="table" slot-scope="{isSelectable, pagingEvent}">
      ...
      <el-table-column :label='$t("asset.waterGage.device.statusName")'>
      ...
      <el-table-column min-width="105" prop="currentLevel" :label='$t("asset.waterGage.device.currentGage")'></el-table-column>
      <el-table-column prop="compName" :label='$t("asset.waterGage.device.compName")'></el-table-column>
      <el-table-column prop="asset" :label='$t("asset.waterGage.device.assetName")'></el-table-column>
