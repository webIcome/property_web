<template>
  <list-content-component :title="title" :service="service">
    ...
    <template slot="table" slot-scope="{isSelectable,pagingEvent,getSignalClass,getPowerClass}">
      ...
      <el-table-column prop="sn" :label='$t("asset.waterGage.device.sn")'></el-table-column>
      <el-table-column prop="deviceModel" :label='$t("asset.waterGage.device.deviceModel")'></el-table-column>
      <el-table-column prop="statusName" :label='$t("asset.waterGage.device.statusName")'></el-table-column>
      <el-table-column prop="currentValue" :label='$t("asset.waterGage.device.currentGage")'></el-table-column>
      <el-table-column prop="projectName" :label='$t("asset.waterGage.device.compName")'></el-table-column>
      <el-table-column prop="assetManageName" :label='$t("asset.waterGage.device.assetName")'></el-table-column>
      <el-table-column prop="address" :label='$t("asset.waterGage.device.address")'></el-table-column>
      <el-table-column prop="alarmThreshold" :label='$t("asset.waterGage.device.alarmThreshold")'></el-table-column>
      <el-table-column prop="alarmDuty" :label='$t("asset.waterGage.device.alarmDuty")'></el-table-column>
      <el-table-column prop="alarmType" :label='$t("asset.waterGage.device.alarmType")'></el-table-column>
      <el-table-column :label='$t("asset.waterGage.device.electricQuantity")'>
      ...
      <el-table-column min-width="120" :label='$t("asset.waterGage.device.signalQuality")'>
        <template slot-scope="scope">
...
<script>
    ...
    import Service from "../../../services/water-gage"
    ...
    export default {
        ...
        data() {
            return {
                service: Service,
                title: this.$t("asset.waterGage.title")
            }
        },
        methods: {
