  ...
  <div class="oper-component">
    ...
    <el-dialog :title="title" :visible.sync="visible" center :width="'500px'">
      <el-form label-width="120px" :model="data" :rules="Rules" :ref="ref" class="el-form-default" :validate-on-rule-change="false">
        <el-form-item :label='$t("asset.waterLevel.device.sn")' prop="sn">
          <el-input v-model.trim="data.sn" :placeholder='$t("common.input")'></el-input>
        </el-form-item>
        <el-form-item :label='$t("asset.waterLevel.device.deviceModel")' prop="deviceModel">
        ...
        <el-form-item :label='$t("asset.waterLevel.device.alarmType")' prop="alarmType">
        ...
        <el-form-item :label='$t("asset.waterLevel.device.compName")' prop="projectIds">
          <select-projects-component v-model="data.projectIds" style="width: 100%"></select-projects-component>
        </el-form-item>
        <el-form-item :label='$t("asset.waterLevel.device.assetName")' prop="assetManageId">
          <select-asset-component v-model="data.assetManageId" style="width: 100%"></select-asset-component>
        </el-form-item>
        <el-form-item :label='$t("asset.waterLevel.device.address")' prop="address">
